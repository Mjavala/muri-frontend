...
empty_message = {"destination": "stat", "message": {}}
# expected return ~ lambda: "invalid message type"
bad_destination = {"destination": "WOLOLOLOLO", "message": {"station": "BARN1"}}
# expected return ~ None
virtual_station = {"destination": "stat", "message": {"station": "VGRS1"}}
