    ...
    async def main_loop(self):
        ...
        while True:
            ...
            if not self.q_stat.empty():
                self.logger.info("Database Queues - stat size: {} ...".format(self.q_stat.qsize()))
                try:
            ...
            if not self.q_0xc.empty():
                self.logger.info("Database Queues - 0xc109 size: {} ...".format(self.q_0xc.qsize()))
                try:
            ...
            if not self.q_0xd.empty():
                self.logger.info("Database Queues - 0xd2a8 size: {} ...".format(self.q_0xd.qsize()))
                try:
