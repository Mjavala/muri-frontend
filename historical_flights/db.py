    ...
    async def main_loop(self):
        ...
        while True:
            ...
            if not self.q_stat.empty():
                logger.info("Database Queues - stat size: {} ...".format(sekf.q_stat.size()))
                try:
            ...
            if not self.q_0xc.empty():
                logger.info("Database Queues - 0xc109 size: {} ...".format(sekf.q_0xc.size()))
                try:
            ...
            if not self.q_0xd.empty():
                logger.info("Database Queues - 0xd2a8 size: {} ...".format(sekf.q_0xd.size()))
                try:
